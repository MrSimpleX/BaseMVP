...
import com.aidai.basemvp.utils.BLog;
import com.aidai.basemvp.utils.NetUtils;
...
public class OkHttpClientManager {
	...
	private OkHttpClientManager() {
		...
		//cookie enabled
		mOkHttpClient.setCookieHandler(new CookieManager(new PersistentCookieStore(App.getContext()), CookiePolicy.ACCEPT_ORIGINAL_SERVER));
